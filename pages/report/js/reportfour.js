var PageReportfive = function(){
    return {
        ...
        funSearch : function()
        {
            ...
            this.reportSevenGrid1.load(reportfiveForm.getData());
            this.reportSevenGrid2.load(reportfiveForm.getData());
            this.reportSevenGrid3.load(reportfiveForm.getData());
            this.reportSevenGrid4.load(reportfiveForm.getData());
        },
